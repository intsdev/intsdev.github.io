<template>
  <section class="head-section">
    <div class="container">
      <div class="row">
        <div class="col-lg-7 col-md">
          ...
          <blockquote class="blockquote">
            ...
            Я Web Developer... <strong>Full-Stack Developer</strong><br>

            На данный момент занимаюсь <strong>Freelance</strong> и личными проектами. Нахожусь <strong>в поиске интересных проектов</strong>, которые в потенциале смогут сделать мир чуточку лучше!</p>
      ...
      <div class="go-down" v-scroll-to="'#skills'">
...
<script>
  ...
  import appWindow from ':src/components/Window';

  export default {
    components: { appWindow, Icon }
  }
</script>
...
<style>
  ...
  .head-section .head-img {
    max-height: 350px;
    margin: 25px auto;
    max-width: 100%;
  }
  .head-section .btn-contact-me {
  ...
  .head-section .btn-contact-me:hover {
