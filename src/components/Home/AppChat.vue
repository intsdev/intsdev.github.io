...
<template>
    ...
    <div class="bar">
      <div class="window-nav">
        <div class="nav-close" @click="onHideChat">
          <span><icon name="times" width="8"/></span>
        </div>
        <div class="nav-hide" @click="onHideChat">
          <span><icon name="minus" width="8"/></span>
        </div>
        <div class="nav-fullscreen">
          <span><icon name="sort" width="8"/></span>
        </div>
      </div>
  ...
  <div v-show="chatHide" class="app-hide">
    ...
    <div @click="onShowChat" class="terminal-icon">
      <img src="/src/assets/chat/terminal.png" alt="">
    </div>
    <div @click="onShowChat" class="terminal-icon">
      <img src="/src/assets/chat/phone.png" alt="">
    </div>
    <div @click="onShowChat" class="terminal-icon">
      <img src="/src/assets/chat/book.png" alt="">
    </div>
